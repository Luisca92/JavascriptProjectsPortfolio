...
document.addEventListener('DOMContentLoaded', function() {
    ...
    days.forEach(day => {
        day.addEventListener('click', () => {
            console.log('Clicked on day:', day.innerText);
            ...
            selectedDate.innerText = 'Selected Date: ' + getFullDate(day.innerText);
        });
    });
    ...
    function getFullDate(day) {
        ...
        return `${months[currentMonth]} ${clickedDate} ${currentYear}`;
    }
});
